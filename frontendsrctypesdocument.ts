...
// Uma linha de part number (o gṛo do output). Todos os campos podem vir nulos.
...
// Documento completo (a tela de reviṣo).
...
// --- Payload do PATCH (reviṣo humana): a mesma forma que o backend espera. ---
